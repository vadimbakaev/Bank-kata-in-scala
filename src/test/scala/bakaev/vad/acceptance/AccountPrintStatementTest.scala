...
class AccountPrintStatementTest extends FlatSpec with Matchers with MockitoSugar {
  ...
  "An account" should "print statement correctly" in {
    ...
    account.deposit(new Amount(1000), OperationDate.of("10-01-2012"))
    account.deposit(new Amount(2000), OperationDate.of("13-01-2012"))
    account.withdrawal(new Amount(500), OperationDate.of("14-01-2012"))
